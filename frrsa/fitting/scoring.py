...
def scoring_unfitted(y_unfitted, x_unfitted, score_type='pearsonr'):
...
def scoring(y_true, y_pred, score_type='pearsonr'):
    """Returns one of three possible scores to be maximised"""
