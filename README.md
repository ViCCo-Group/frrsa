...
There are default values for all parameters, which we partly assessed (see our [paper](https://www.sciencedirect.com/science/article/pii/S105381192200413X)). However, you can input custom parameters as you wish. For now, see the [respective docstring](https://github.com/ViCCo-Group/frrsa/blob/master/frrsa/fitting/crossvalidation.py#L35) for an explanation of all returned objects. A more elaborate documentation is work in progress (see [#14](/../../issues/14)).
