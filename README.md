...
4. There are other combinations of `outer_k` and the number of conditions (also when the number of conditions is bigger than 14) that would yield too few (inner or outer) test conditions if unchanged. This has been accounted for and will be taken into account automatically [#17](/../../issues/17)).
